...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { date: @race.date, location: @race.location, name: @race.name, time: @race.time } }, as: :json
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { date: @race.date, location: @race.location, name: @race.name, time: @race.time } }, as: :json
    assert_response 200
  end
